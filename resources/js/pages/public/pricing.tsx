...
function Tick() {
    return <Check className="mt-0.5 size-4 flex-none text-[#8a651c]" aria-hidden />;
}
        ...
        <div className="min-h-screen bg-[#faf6ef] font-['DM_Sans'] text-[#191613] antialiased selection:bg-[#e9c176]/40">
            ...
            <header className="fixed inset-x-0 top-0 z-50 border-b border-[#191613]/8 bg-[#faf6ef]/85 backdrop-blur-md">
                <nav className="mx-auto flex max-w-[1480px] items-center justify-between px-5 py-4 md:px-12">
                    ...
                    <div className="hidden items-center gap-9 md:flex">
                        ...
                        <a href="#planners" className="text-[13px] tracking-wide text-[#52493d] hover:text-[#8a651c]">For planners</a>
            ...
            <section className="px-5 pt-32 pb-12 md:px-12 md:pt-40 md:pb-16">
                <div className="mx-auto max-w-[1480px]">
                    <Reveal>
                        <p className="mb-4 text-[11px] tracking-[0.3em] text-[#8a651c] uppercase">Pricing</p>
                        <h1 className={`${fraunces} max-w-3xl text-5xl leading-[1.02] font-light sm:text-6xl md:text-7xl`}>
                            Honest pricing, <em className="text-[#8a651c]">no subscription traps.</em>
                        </h1>
            ...
            <section id="couples" className="px-5 pb-20 md:px-12 md:pb-28">
                <Stagger className="mx-auto grid max-w-[1480px] gap-6 md:grid-cols-3">
                    {/* Free */}
                    <StaggerItem className="flex flex-col border border-[#191613]/10 bg-white p-8">
                        <p className="text-[11px] tracking-[0.3em] text-[#8a651c] uppercase">For couples</p>
                        <h2 className={`${fraunces} mt-3 text-3xl font-light`}>Free</h2>
                        <p className={`${fraunces} mt-4 text-5xl font-light`}>
                            $0<span className="ml-2 align-middle text-sm text-[#52493d]">forever</span>
                        </p>
                        <p className="mt-4 text-sm leading-relaxed text-[#52493d]">
                            The full planning studio and the marketplace. No credit card, no trial clock.
                        </p>
                        <ul className="mt-6 mb-8 space-y-3 text-sm text-[#3a352e]">
                            {freeFeatures.map((f) => (
                        ...
                        <Link
                            href="/register"
                            className="mt-auto inline-flex items-center justify-center gap-2 border border-[#191613] px-6 py-3.5 text-[11px] font-semibold tracking-[0.2em] uppercase transition-colors hover:bg-[#191613] hover:text-[#faf6ef]"
                        >
                            Start free
                        </Link>
                    </StaggerItem>
                    ...
                    {/* Atelier */}
                    <StaggerItem className="relative flex flex-col border-2 border-[#8a651c] bg-white p-8 shadow-[0_30px_60px_-30px_rgba(138,101,28,0.45)]">
                        <span className="absolute -top-3 left-8 bg-[#8a651c] px-3 py-1 text-[10px] font-semibold tracking-[0.18em] text-white uppercase">
                            Most loved
                        </span>
                        <p className="text-[11px] tracking-[0.3em] text-[#8a651c] uppercase">For couples</p>
                        <h2 className={`${fraunces} mt-3 text-3xl font-light`}>Atelier</h2>
                        <p className={`${fraunces} mt-4 text-5xl font-light`}>
                            $99<span className="ml-2 align-middle text-sm text-[#52493d]">once · per wedding</span>
                        </p>
                        <p className="mt-4 text-sm leading-relaxed text-[#52493d]">
                        ...
                        <Link
                            href="/register"
                            className="mt-auto inline-flex items-center justify-center gap-2 bg-[#191613] px-6 py-3.5 text-[11px] font-semibold tracking-[0.2em] text-[#faf6ef] uppercase transition-colors hover:bg-[#8a651c]"
                        >
                    ...
                    {/* Planner HQ */}
                    <StaggerItem className="flex flex-col border border-[#191613]/10 bg-white p-8">
                        <p id="planners" className="scroll-mt-24 text-[11px] tracking-[0.3em] text-[#8a651c] uppercase">For planners</p>
                        <h2 className={`${fraunces} mt-3 text-3xl font-light`}>Planner HQ</h2>
                        <p className={`${fraunces} mt-4 text-5xl font-light`}>
                            $499<span className="ml-2 align-middle text-sm text-[#52493d]">per year</span>
                        </p>
                        <p className="mt-4 text-sm leading-relaxed text-[#52493d]">
            ...
            {/* Vendors */}
            <section id="vendors" className="border-t border-[#191613]/10 bg-[#191613] px-5 py-20 text-[#faf6ef] md:px-12 md:py-28">
                <div className="mx-auto grid max-w-[1480px] items-center gap-12 md:grid-cols-2">
                    <Reveal>
                        <p className="mb-3 text-[11px] tracking-[0.3em] text-[#e6d4a8] uppercase">For vendors</p>
                        <h2 className={`${fraunces} text-4xl font-light sm:text-5xl`}>
                            List free. Pay only <em className="text-[#e6d4a8]">when you're booked.</em>
                        </h2>
                        ...
                        <Link
                            href="/register"
                            className="mt-8 inline-flex items-center gap-3 bg-[#e6d4a8] px-9 py-4 text-[11px] font-semibold tracking-[0.22em] text-[#191613] uppercase transition-colors hover:bg-white"
                        >
            ...
            <section id="faq" className="px-5 py-20 md:px-12 md:py-28">
                <div className="mx-auto max-w-[880px]">
                    <Reveal className="mb-12">
                        <p className="mb-3 text-[11px] tracking-[0.3em] text-[#8a651c] uppercase">Questions</p>
                        <h2 className={`${fraunces} text-4xl font-light sm:text-5xl`}>
                            Asked <em className="text-[#8a651c]">honestly answered.</em>
                        </h2>
                    </Reveal>
                    <Stagger className="divide-y divide-[#191613]/10">
                        {faqs.map((f) => (
                            <StaggerItem key={f.q} className="py-7">
                                <h3 className={`${fraunces} text-xl font-normal`}>{f.q}</h3>
                                <p className="mt-3 max-w-2xl text-[15px] leading-relaxed text-[#52493d]">{f.a}</p>
                            </StaggerItem>
                        ))}
                    </Stagger>
                </div>
